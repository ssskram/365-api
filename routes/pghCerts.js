...
// get all ICC history
router.get("/iccHistory", async (req, res) => {
  fetch(
    "https://cityofpittsburgh.sharepoint.com/sites/certs/_api/web/lists/GetByTitle('ICC History')/items?$top=5000",
    {
      method: "GET",
      headers: new Headers({
        Authorization: "Bearer " + (await refreshToken()),
...
// new icc record
router.post("/iccHistory", async (req, res) => {
  fetch(
    "https://cityofpittsburgh.sharepoint.com/sites/certs/_api/web/lists/GetByTitle('ICC History')/items",
    {
      method: "POST",
      headers: new Headers({
        Authorization: "Bearer " + (await refreshToken()),
...
// update icc record
router.post("/updateIccRecord", async (req, res) => {
  fetch(
    "https://cityofpittsburgh.sharepoint.com/sites/certs/_api/web/lists/GetByTitle('ICC History')/items(" +
      req.query.id +
      ")",
...
// delete icc record
router.delete("/deleteIccRecord", async (req, res) => {
  fetch(
    "https://cityofpittsburgh.sharepoint.com/sites/certs/_api/web/lists/GetByTitle('ICC History')/items(" +
      req.query.id +
      ")",
...
// get all ucc history
router.get("/uccHistory", async (req, res) => {
  fetch(
    "https://cityofpittsburgh.sharepoint.com/sites/certs/_api/web/lists/GetByTitle('UCC History')/items?$top=5000",
    {
      method: "GET",
      headers: new Headers({
        Authorization: "Bearer " + (await refreshToken()),
...
// new ucc record
router.post("/uccHistory", async (req, res) => {
  fetch(
    "https://cityofpittsburgh.sharepoint.com/sites/certs/_api/web/lists/GetByTitle('UCC History')/items",
    {
      method: "POST",
      headers: new Headers({
        Authorization: "Bearer " + (await refreshToken()),
...
// update cert record
router.post("/updateUccRecord", async (req, res) => {
  fetch(
    "https://cityofpittsburgh.sharepoint.com/sites/certs/_api/web/lists/GetByTitle('UCC History')/items(" +
      req.query.id +
      ")",
...
// delete cert record
router.delete("/deleteUccRecord", async (req, res) => {
  fetch(
    "https://cityofpittsburgh.sharepoint.com/sites/certs/_api/web/lists/GetByTitle('UCC History')/items(" +
      req.query.id +
      ")",
